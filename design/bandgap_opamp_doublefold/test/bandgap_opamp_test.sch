...
C {bandgap_opamp_doublefold/bandgap_opamp_doublefold.sym} 630 -230 0 0 {name=xdut}
C {isource.sym} 520 -380 0 0 {name=I0 value=6u}
...
m=1
ac=1000Meg}
C {spice_probe.sym} 780 -230 0 0 {name=p1 analysis=tran voltage=0.5399}
C {spice_probe.sym} 90 -250 0 0 {name=p2 analysis=tran voltage=0.54}
C {spice_probe.sym} 430 -210 0 0 {name=p3 analysis=tran voltage=0.5399}
