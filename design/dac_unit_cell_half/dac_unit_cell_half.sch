...
N 90 -310 110 -310 { lab=vdda}
N 90 -510 90 -310 { lab=vdda}
N 90 -510 110 -510 { lab=vdda}
N 860 -310 880 -310 { lab=vdda}
N 880 -510 880 -310 { lab=vdda}
N 860 -510 880 -510 { lab=vdda}
N 880 -860 880 -510 { lab=vdda}
N 90 -860 90 -510 { lab=vdda}
N 110 -480 110 -340 { lab=#net1}
N 860 -480 860 -340 { lab=#net2}
N 150 -310 820 -310 { lab=cas_bias}
N 150 -510 300 -510 { lab=ctl_p}
N 300 -590 300 -510 { lab=ctl_p}
N 300 -700 300 -680 { lab=drive_supply}
N 660 -700 660 -680 { lab=drive_supply}
N 660 -590 660 -510 { lab=ctl_n}
N 660 -510 820 -510 { lab=ctl_n}
N 300 -510 300 -440 { lab=ctl_p}
N 660 -510 660 -440 { lab=ctl_n}
N 300 -380 300 -340 { lab=ctl_s}
...
N 0 -700 300 -700 { lab=drive_supply}
N 330 -1000 400 -1000 { lab=#net5}
N 360 -1110 400 -1110 { lab=clk}
N 220 -1090 400 -1090 { lab=data}
N 360 -1020 400 -1020 { lab=clk}
N 360 -1110 360 -1020 { lab=clk}
N 220 -1000 250 -1000 { lab=data}
N 220 -1090 220 -1000 { lab=data}
N 860 -240 960 -240 { lab=out_n}
N 860 -280 860 -240 { lab=out_n}
...
N 860 -830 860 -790 { lab=vdda}
N 860 -790 880 -790 { lab=vdda}
...
C {sky130_fd_pr/pfet_01v8.sym} 840 -310 0 0 {name=Mcas_n
L=0.15
W=0.42
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
...
C {sky130_fd_pr/pfet_01v8.sym} 130 -510 0 1 {name=Msteer_p
L=0.15
W=0.42
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
...
C {sky130_fd_pr/pfet_01v8.sym} 840 -510 0 0 {name=Msteer_n
L=0.15
W=0.42
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
...
C {sky130_fd_pr/nfet_01v8.sym} 280 -410 0 0 {name=Mdrive_p
L=0.15
W=0.42
nf=1 
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 680 -410 0 1 {name=Mdrive_n
L=0.15
W=0.42
nf=1
mult=1
...
C {sky130_fd_pr/nfet_01v8.sym} 580 -510 0 0 {name=Mdrive_comp_n
L=0.15
W=0.84
nf=1
mult=2
...
C {sky130_fd_pr/pfet_01v8.sym} 640 -650 0 0 {name=Mload_n
L=0.15
W=0.84
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
