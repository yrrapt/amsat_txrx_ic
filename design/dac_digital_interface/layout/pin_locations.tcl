...
set_io_pin_constraint 	-direction input -names clk_i* 						-region right:*
set_io_pin_constraint 	-direction input -names input_binary_i* 			-region right:*
set_io_pin_constraint 	-direction input -names randomise_en_i 				-region right:*
set_io_pin_constraint 	-direction input -names rst_ni 						-region right:*
