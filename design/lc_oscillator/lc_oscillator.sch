...
S {}
E {}
N 170 -710 170 -580 { lab=vdd}
N 650 -710 650 -580 { lab=vdd}
N 650 -680 930 -680 { lab=out_n}
N 170 -620 930 -620 { lab=out_p}
N 0 -520 50 -520 { lab=vctl}
N 0 -260 50 -260 { lab=bias_20u_p}
...
C {lc_oscillator_inductor_diff/lc_oscillator_inductor_diff_lvs.sym} 410 -790 0 0 {name=x3}
