...
"}
C {vsource.sym} 0 -140 0 0 {name=Vdd value="pulse(0 \{vdd\} 1m 1m 1m 10 5 0"}
...
C {spice_probe.sym} 600 -370 0 0 {name=p9 analysis=tran voltage=3.8662e-32}
C {ammeter.sym} 600 -420 0 0 {name=viout current=4.2981e-37}
...
C {ammeter.sym} 600 -520 0 0 {name=vptat current=1.4019e-39}
C {ammeter.sym} 810 -520 0 0 {name=vctat current=4.2841e-37}
C {vsource.sym} 1250 -50 0 0 {name=Vctl_ptat4 value="pulse(0 \{vdd\} 10m 1m 1m 10 5 0)"}
...
C {vsource.sym} 1250 -250 0 0 {name=Vctl_ctat4 value="pulse(0 \{vdd\} 10m 1m 1m 10 5 0)"}
...
C {vsource.sym} 1650 -440 0 0 {name=Ven value="pulse(0 \{vdd\} 10m 1m 1m 10 5 0)"}
...
C {ammeter.sym} 1020 -420 0 0 {name=viout1 current=4.2840e-37}
...
C {ammeter.sym} 1020 -520 0 0 {name=vptat2 current=-6.2095e-103}
C {ammeter.sym} 1230 -520 0 0 {name=vctat3 current=4.2840e-37}
C {bandgap_core/bandgap_core_idealr.sym} 310 -140 0 0 {name=x1}
