...
C {spice_probe.sym} 600 -370 0 0 {name=p9 analysis=tran voltage=0.838}
C {ammeter.sym} 600 -420 0 0 {name=viout current=9.3132e-06}
...
C {ammeter.sym} 600 -520 0 0 {name=vptat current=3.7414e-06}
C {ammeter.sym} 810 -520 0 0 {name=vctat current=5.5718e-06}
...
C {ammeter.sym} 1020 -420 0 0 {name=viout1 current=9.4917e-06}
...
C {ammeter.sym} 1020 -520 0 0 {name=vptat2 current=3.7711e-06}
C {ammeter.sym} 1230 -520 0 0 {name=vctat3 current=5.7206e-06}
