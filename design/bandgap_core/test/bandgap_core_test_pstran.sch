...
N 2000 -410 2000 -390 { lab=GND}
N 2000 -390 2000 -370 { lab=GND}
...
N 1280 -490 1280 -480 { lab=#net7}
N 1280 -480 1280 -470 { lab=#net7}
...
"}
C {vsource.sym} 0 -80 0 1 {name=Vdd value="pulse(0 \{vdd-0.1\} 10n rise_time rise_time 10 20 0)"}
...
C {ammeter.sym} 890 -520 0 0 {name=vctat current=6.9903e-06}
C {vsource.sym} 1600 -50 0 0 {name=Vctl_ptat4 value="pulse(0 \{ctl_ptat4\} 10n rise_time rise_time 10 20 0)"}
...
C {vsource.sym} 1600 -250 0 0 {name=Vctl_ctat4 value="pulse(0 \{ctl_ctat4\} 10n rise_time rise_time 10 20 0)"}
...
C {vsource.sym} 2000 -440 0 0 {name=Ven value="pulse(0 \{en\} 10n rise_time rise_time 10 20 0)"}
...
spiceprefix=X
m=1}
C {ammeter.sym} 1280 -420 0 0 {name=viout1 current=0.0000e+00}
...
C {ammeter.sym} 1280 -520 0 0 {name=vptat2 current=2.8422e-14}
C {ammeter.sym} 1580 -520 0 0 {name=vctat3 current=-2.8422e-14}
C {vsource.sym} 0 -190 0 1 {name=Vdd1 value="pulse(0 0.1 10n rise_time rise_time 40u 80u 0)"}
