...
N 970 -1150 1070 -1150 {lab=#net3}
N 1070 -1150 1070 -1120 {lab=#net3}
N 1070 -1150 1310 -1150 {lab=#net3}
N 1310 -1150 1310 -1120 {lab=#net3}
N 1250 0 1310 0 {lab=GND}
N 780 0 1010 0 {lab=GND}
N 1310 -490 1310 -430 {lab=#net1}
N 1370 0 1560 0 {lab=GND}
N 440 -450 440 0 {lab=GND}
N 1560 -470 2010 -470 {lab=#net4}
N 1310 -1150 1560 -1150 {lab=#net3}
N 440 -970 440 -570 {lab=#net3}
N 2110 -750 2110 -510 {lab=#net3}
N 2080 -1150 2110 -1150 {lab=#net3}
N 1560 -1150 1560 -1120 {lab=#net3}
N 2500 -1150 2500 -1120 {lab=#net3}
N 2290 -1150 2500 -1150 {lab=#net3}
N 2290 -1150 2290 -1120 {lab=#net3}
N 2500 -120 2500 -90 {lab=#net5}
N 2290 -910 2290 -830 {lab=#net5}
N 2290 -830 2500 -830 {lab=#net5}
N 2570 -60 2750 -60 {lab=#net5}
N 2500 -120 2570 -120 {lab=#net5}
N 2570 -120 2570 -60 {lab=#net5}
...
N 2110 -1150 2290 -1150 {lab=#net3}
N 2500 -900 2500 -830 {lab=#net5}
N 2540 -60 2570 -60 {lab=#net5}
...
N 930 -1050 930 -770 {lab=ptat}
N 930 -1050 980 -1050 {lab=ptat}
N 1720 -430 2010 -430 {lab=#net1}
N 200 -1150 440 -1150 {lab=#net3}
N 310 0 440 0 {lab=GND}
...
N 2080 -720 2080 -510 { lab=#net6}
N 1070 -900 1070 -670 { lab=#net7}
N 1070 -610 1070 -530 { lab=#net2}
N 1310 -610 1310 -490 { lab=#net1}
N 1310 -900 1310 -670 { lab=#net8}
N 1560 -610 1560 -470 { lab=#net4}
N 1560 -900 1560 -670 { lab=#net9}
N 1310 -430 1720 -430 {lab=#net1}
N 470 -940 470 -630 { lab=#net10}
N 1720 -490 1720 -430 { lab=#net1}
N 1720 -570 2230 -570 { lab=ctat}
N 1720 -1050 1720 -570 {lab=ctat}
N 60 -1150 200 -1150 { lab=#net3}
N 200 -1150 200 -990 { lab=#net3}
N 200 -890 200 0 { lab=GND}
N 0 0 200 0 { lab=GND}
N 60 -940 110 -940 { lab=#net3}
N 60 -1150 60 -940 { lab=#net3}
N 440 -970 470 -970 { lab=#net3}
N 470 -1150 470 -1000 { lab=#net3}
N 2080 -750 2110 -750 { lab=#net3}
N 2080 -1150 2080 -780 { lab=#net3}
N 1560 -1150 2080 -1150 { lab=#net3}
N 440 -1150 440 -970 {lab=#net3}
N 2110 -1150 2110 -750 {lab=#net3}
N 440 -1150 470 -1150 {lab=#net3}
N 0 -1150 60 -1150 { lab=#net3}
N 0 -630 0 0 { lab=GND}
N 0 -1150 0 -690 { lab=#net3}
N 780 -400 780 -100 { lab=#net11}
N 620 0 780 0 {lab=GND}
N 310 -770 930 -770 { lab=ptat}
N 780 -40 780 0 { lab=GND}
N 960 -1120 970 -1120 { lab=#net3}
N 970 -1150 970 -1120 { lab=#net3}
N 930 -1150 930 -1120 { lab=#net3}
N 890 -1120 900 -1120 { lab=#net3}
N 890 -1150 890 -1120 { lab=#net3}
N 930 -1150 970 -1150 {lab=#net3}
N 890 -1150 930 -1150 {lab=#net3}
N 840 -1150 890 -1150 {lab=#net3}
N 990 -490 1310 -490 { lab=#net1}
N 1030 -530 1070 -530 { lab=#net2}
N 780 -530 840 -530 { lab=#net12}
N 740 -490 840 -490 { lab=#net13}
N 780 -530 780 -460 { lab=#net12}
N 620 -400 620 -100 { lab=#net14}
N 620 -40 620 0 { lab=GND}
N 620 -490 620 -460 { lab=#net13}
N 960 -650 990 -650 { lab=#net1}
N 960 -690 1030 -690 { lab=#net2}
N 1030 -690 1030 -530 { lab=#net2}
N 990 -650 990 -490 { lab=#net1}
N 1560 -470 1560 -220 { lab=#net4}
N 2790 -880 2790 -90 { lab=cas}
N 2500 -830 2500 -120 { lab=#net5}
N 2110 -390 2110 0 { lab=GND}
N 1070 -160 1070 -90 {lab=#net15}
N 2790 -1150 2790 -1080 {lab=#net3}
N 2830 -1050 2870 -1050 {lab=cas}
N 2870 -1050 2870 -970 {lab=cas}
N 2790 -1020 2790 -990 {lab=#net16}
N 2770 -1050 2790 -1050 {lab=#net3}
N 2770 -1150 2770 -1050 {lab=#net3}
N 2770 -1150 2790 -1150 {lab=#net3}
N 2770 -1050 2770 -970 { lab=#net3}
N 2770 -970 2790 -970 { lab=#net3}
...
N 2500 -1150 2770 -1150 {lab=#net3}
N 440 0 620 0 {lab=GND}
N 900 -490 990 -490 { lab=#net1}
N 900 -530 1030 -530 { lab=#net2}
N 540 -530 780 -530 { lab=#net12}
N 540 -490 620 -490 { lab=#net13}
N 680 -550 740 -550 { lab=#net13}
N 740 -550 740 -490 { lab=#net13}
N 840 -1150 840 -1080 { lab=#net3}
N 930 -1080 930 -1050 { lab=ptat}
N 310 -110 310 0 { lab=GND}
N 360 -540 360 -510 { lab=ac_op}
N 360 -660 360 -600 { lab=ptat}
N 310 -660 360 -660 { lab=ptat}
N 310 -770 310 -660 {lab=ptat}
N 200 0 310 0 {lab=GND}
N 470 -1150 840 -1150 {lab=#net3}
N 620 -490 740 -490 { lab=#net13}
N 310 -660 310 -420 { lab=ptat}
N 310 -360 310 -170 { lab=#net17}
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 2520 -60 0 1 {name=M3
L=8
W=7
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 2770 -60 0 0 {name=M1
L=8
W=7
ad="[expr @W *0.29]" pd="[expr 2*(@W + 0.29)]"
as="[expr @W *0.29]" ps="[expr 2*(@W + 0.29)]"
...
C {bandgap_cascurr_cell/bandgap_cascurr_cell.sym} 1560 -1010 0 1 {name=x7 m=8}
...
C {vsource.sym} 780 -70 0 0 {name=Vin value="dc=0 ac=-1"}
C {lab_wire.sym} 920 -700 0 1 {name=l16 sig_type=std_logic lab=ac}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 930 -1100 1 1 {name=Mcurr2
L=8
W=7
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
...
C {vsource.sym} 620 -70 0 0 {name=Vin1 value="dc=0 ac=1"}
C {vcvs.sym} 920 -670 0 1 {name=E1 value=1}
C {gnd.sym} 920 -640 0 0 {name=l17 lab=GND}
...
.control
   ...
   setplot ac1
   set units=degrees
   gnuplot bandgap_core_stability2 db(ac_op) db(1/ac)
.endc
"}
C {res_ac.sym} 870 -530 1 0 {name=R3
value=1u
device=resistor
m=1
ac=1G}
C {res_ac.sym} 870 -490 1 0 {name=R5
value=1u
device=resistor
m=1
ac=1G}
C {res_ac.sym} 780 -430 2 0 {name=R4
value=1G
device=resistor
m=1
ac=1u}
C {res_ac.sym} 620 -430 2 0 {name=R6
value=1G
device=resistor
m=1
ac=1u}
C {sky130_fd_pr/pfet_01v8_lvt.sym} 2810 -1050 0 1 {name=Mtri_bias_cas
L=8
W=5
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 2810 -970 0 1 {name=Mcas_bias
L=0.5
W=5
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
...
device=resistor
m=1}
C {capa.sym} 680 -520 0 0 {name=C3
m=1
value=100p
footprint=1206
device="ceramic capacitor"}
C {vsource.sym} 310 -140 0 0 {name=Vin2 value="dc=0 ac=-1"}
C {lab_wire.sym} 360 -510 0 0 {name=l18 sig_type=std_logic lab=ac_op}
C {res_ac.sym} 360 -570 2 0 {name=R7
value=1u
device=resistor
m=1
ac=1G}
C {res_ac.sym} 310 -390 2 0 {name=R8
value=1G
device=resistor
m=1
ac=1u}
