...
N 970 -1150 1070 -1150 {lab=#net2}
N 1070 -1150 1070 -1120 {lab=#net2}
N 1070 -1150 1310 -1150 {lab=#net2}
N 1310 -1150 1310 -1120 {lab=#net2}
N 1250 0 1310 0 {lab=GND}
N 620 0 1010 0 {lab=GND}
N 1310 -490 1310 -430 {lab=#net1}
N 1370 0 1560 0 {lab=GND}
N 440 -450 440 0 {lab=GND}
N 1560 -470 2010 -470 {lab=#net3}
N 1310 -1150 1560 -1150 {lab=#net2}
N 440 -970 440 -570 {lab=#net2}
N 2110 -750 2110 -510 {lab=#net2}
N 2080 -1150 2110 -1150 {lab=#net2}
N 1560 -1150 1560 -1120 {lab=#net2}
N 2500 -1150 2500 -1120 {lab=#net2}
N 2290 -1150 2500 -1150 {lab=#net2}
N 2290 -1150 2290 -1120 {lab=#net2}
...
N 2110 -1150 2290 -1150 {lab=#net2}
...
N 60 -1150 200 -1150 { lab=#net2}
N 200 -1150 200 -990 { lab=#net2}
N 200 -890 200 0 { lab=GND}
N 0 0 200 0 { lab=GND}
N 60 -940 110 -940 { lab=#net2}
N 60 -1150 60 -940 { lab=#net2}
N 440 -970 470 -970 { lab=#net2}
N 470 -1150 470 -1000 { lab=#net2}
N 2080 -750 2110 -750 { lab=#net2}
N 2080 -1150 2080 -780 { lab=#net2}
N 1560 -1150 2080 -1150 { lab=#net2}
N 440 -1150 440 -970 {lab=#net2}
N 2110 -1150 2110 -750 {lab=#net2}
N 440 -1150 470 -1150 {lab=#net2}
N 0 -1150 60 -1150 { lab=#net2}
N 0 -630 0 0 { lab=GND}
N 0 -1150 0 -690 { lab=#net2}
N 310 -770 930 -770 { lab=ptat}
N 960 -1120 970 -1120 { lab=#net2}
N 970 -1150 970 -1120 { lab=#net2}
N 930 -1150 930 -1120 { lab=#net2}
N 890 -1120 900 -1120 { lab=#net2}
N 890 -1150 890 -1120 { lab=#net2}
N 930 -1150 970 -1150 {lab=#net2}
N 890 -1150 930 -1150 {lab=#net2}
N 470 -1150 890 -1150 {lab=#net2}
N 540 -490 1310 -490 { lab=#net1}
N 900 -530 1070 -530 { lab=ac}
N 620 -400 620 -100 { lab=#net10}
...
N 1070 -160 1070 -90 {lab=#net11}
N 2790 -1150 2790 -1080 {lab=#net2}
N 2830 -1050 2870 -1050 {lab=cas}
N 2870 -1050 2870 -970 {lab=cas}
N 2790 -1020 2790 -990 {lab=#net12}
N 2770 -1050 2790 -1050 {lab=#net2}
N 2770 -1150 2770 -1050 {lab=#net2}
N 2770 -1150 2790 -1150 {lab=#net2}
N 2770 -1050 2770 -970 { lab=#net2}
N 2770 -970 2790 -970 { lab=#net2}
...
N 2500 -1150 2770 -1150 {lab=#net2}
N 440 0 620 0 {lab=GND}
N 540 -530 840 -530 { lab=#net13}
N 930 -1050 930 -770 { lab=ptat}
N 310 -510 360 -510 { lab=ptat}
N 930 -1080 930 -1050 { lab=ptat}
N 620 -530 620 -460 { lab=#net13}
...
C {lab_wire.sym} 920 -530 0 1 {name=l16 sig_type=std_logic lab=ac}
...
.endc
"}
C {res_ac.sym} 870 -530 1 0 {name=R5
value=1u
device=resistor
m=1
ac=1G}
