...
C {devices/iopin.sym} 0 -420 0 1 {name=p3 lab=vddd}
C {devices/ipin.sym} 0 -360 0 0 {name=p4 lab=bias_10u_p}
C {devices/ipin.sym} 0 -230 0 0 {name=p5 lab=clk}
C {devices/ipin.sym} 0 -150 0 0 {name=p6 lab=data[9:0]}
C {devices/opin.sym} 1120 -210 0 0 {name=p7 lab=out_p}
C {devices/opin.sym} 1120 -190 0 0 {name=p8 lab=out_n}
C {devices/ipin.sym} 0 -170 0 0 {name=p9 lab=en}
C {devices/ipin.sym} 0 -190 0 0 {name=p10 lab=randomise}
C {dac_digital_interface/dac_digital_interface.sym} 310 -190 0 0 {name=x1}
C {devices/ipin.sym} 0 -210 0 0 {name=p11 lab=rst_n}
C {devices/lab_pin.sym} 740 -240 0 0 {name=l1 sig_type=std_logic lab=clk}
