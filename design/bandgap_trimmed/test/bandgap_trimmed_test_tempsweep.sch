...
N 1150 -100 1150 -80 { lab=ctl_ptat[5]}
N 1150 -100 1190 -100 { lab=ctl_ptat[5]}
N 1150 -20 1150 0 { lab=GND}
N 1150 -300 1150 -280 { lab=ctl_ctat[5]}
N 1150 -300 1190 -300 { lab=ctl_ctat[5]}
N 1150 -220 1150 -200 { lab=GND}
N 1150 -200 1250 -200 { lab=GND}
N 1150 -0 1250 0 { lab=GND}
C {..//bandgap_trimmed.sym} 310 -140 0 0 {name=xdut}
...
C {lab_wire.sym} 180 -130 0 0 {name=l16 sig_type=std_logic lab=ctl_ptat[5:0]}
C {lab_wire.sym} 180 -110 0 0 {name=l17 sig_type=std_logic lab=ctl_ctat[5:0]}
...
C {vsource.sym} 1150 -50 0 0 {name=Vctl_ptat5 value=\{ctl_ptat5\}}
C {gnd.sym} 1150 0 0 0 {name=l34 lab=GND}
C {lab_wire.sym} 1150 -100 0 1 {name=l35 sig_type=std_logic lab=ctl_ptat[5]}
C {vsource.sym} 1150 -250 0 0 {name=Vctl_ctat5 value=\{ctl_ctat5\}}
C {gnd.sym} 1150 -200 0 0 {name=l36 lab=GND}
C {lab_wire.sym} 1150 -300 0 1 {name=l37 sig_type=std_logic lab=ctl_ctat[5]}
