...
# xschem -n -q -o "$run_dir" --tcl "set top_subckt 1set bus_replacement_char {[]}" "design/$1/$1.sch"
...
# netgen -batch lvs "$1_lvs_ext.spice" ""$1".spice" "$SKY130A/libs.tech/netgen/sky130A_setup.tcl" lvs_report.out -json
