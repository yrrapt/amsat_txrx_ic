...
C {bandgap_opamp/bandgap_opamp.sym} 540 -390 0 1 {name=xptatop}
...
"}
C {bandgap_opamp/bandgap_opamp.sym} 2030 -480 0 0 {name=xctatop}
...
C {sky130_fd_pr/pfet_01v8_lvt.sym} 2720 -800 0 1 {name=M8
L=8
W=5
ad="'W * 0.29'" pd="'2 * (W + 0.29)'"
as="'W * 0.29'" ps="'2 * (W + 0.29)'"
