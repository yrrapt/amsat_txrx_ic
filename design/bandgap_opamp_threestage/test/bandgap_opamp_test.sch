...
C {isource.sym} 520 -380 0 0 {name=I0 value=10u}
C {vsource.sym} 90 -150 0 0 {name=V2 value="dc=0.7 ac=0"}
...
m=1
ac=1000Meg}
C {spice_probe.sym} 780 -230 0 0 {name=p1 analysis=tran voltage=0.7022}
C {spice_probe.sym} 90 -250 0 0 {name=p2 analysis=tran voltage=0.7}
