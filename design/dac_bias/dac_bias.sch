...
N 640 -60 680 -60 {lab=diff_bias}
N 640 -140 640 -60 {lab=diff_bias}
...
N 430 -140 640 -140 { lab=diff_bias}
N 370 -140 430 -140 { lab=diff_bias}
...
N 290 -170 290 -140 { lab=diff_bias}
...
N 90 -120 90 -90 { lab=diff_bias}
N 90 -120 290 -120 { lab=diff_bias}
...
N 640 -140 1130 -140 { lab=diff_bias}
...
C {devices/lab_pin.sym} 340 -510 0 0 {name=l14 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 340 -570 0 0 {name=l1 sig_type=std_logic lab=vss}
C {devices/lab_pin.sym} 340 -630 0 0 {name=l2 sig_type=std_logic lab=vss}
...
C {devices/iopin.sym} 0 -720 2 0 {name=p3 lab=vddd}
...
C {devices/ipin.sym} 0 -350 0 0 {name=p6 lab=en}
...
C {devices/ipin.sym} 0 -330 0 0 {name=p8 lab=en_n}
